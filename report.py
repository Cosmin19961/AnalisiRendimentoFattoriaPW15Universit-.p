...
Contenitore_Stampa_Report = {  # CAMBIO
    ...
    "stampa_report("latte_munto_atteso", latte_giornaliero_atteso=latte_giornaliero_atteso),
    "stampa_report("latte_pastorizzato_effettivo", latte_pastorizzato=latte_pastorizzato),
